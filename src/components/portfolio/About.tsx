            ...
            <CardContent className="p-8">
              <div className="prose prose-lg max-w-none text-foreground">
                <p className="text-lg leading-relaxed mb-6">
                  I am a passionate <span className="text-primary font-semibold">Artificial Intelligence and Machine Learning</span> student 
                ...
                <p className="text-lg leading-relaxed mb-6">
                  Through my academic pursuits and hands-on projects, I have developed strong <span className="text-primary font-semibold">problem-solving abilities</span> 
